        ...
        _toolbarsearch_addColumnsToHeaderRow: function ($tr) {
            ...
            if (this.options.toolbarreset) {
                ...
                $resetbutton.click(function () {
                    ...
                    //self.load({}); // se comento para que no marcar un error 
                    //jtablebtnsearch
                    $('#jtablebtnsearch').click(); //siempre debe existir un boton con este nombre en el formulario 
                });
                $tr.append($reset);
            }
        },
